"""Описание работы модуля и логики функций."""
...
def attack(char_name: str, char_class: str) -> str:
    """Описание работы фукнкции attack."""
...
def defence(char_name: str, char_class: str) -> str:
    """Описание работы фукнкции defence."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Описание работы фукнкции special."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Описание работы фукнкции start_traning."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Описание работы фукнкции выбора персонажа."""
    approve_choice = None
    char_class = None
